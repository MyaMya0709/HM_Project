...
public class UI_EnhancePopup : MonoBehaviour
{
    ...
    {
        afterLevel_TMP.text = $"Lv.{GameManager.Instance.weaponData.baseWeaponLevel}";
    ...
    public void UIInfoSet()
    {
        ...
        before_AT_AttackDamage_TMP.text = (GameManager.Instance.weaponData.totalDamage * GameManager.Instance.weaponData.data.baseWeaponEffectList[GameManager.Instance.weaponData.baseWeaponLevel].attackEffect.damageMultiple).ToString();
        ...
        before_AT_StunDuration_TMP.text = GameManager.Instance.weaponData.data.baseWeaponEffectList[GameManager.Instance.weaponData.baseWeaponLevel].attackEffect.stun.valueB.ToString();
        before_AT_SlowDuration_TMP.text = GameManager.Instance.weaponData.data.baseWeaponEffectList[GameManager.Instance.weaponData.baseWeaponLevel].attackEffect.slow.valueA.ToString();
        before_AT_SlowDecrease_TMP.text = GameManager.Instance.weaponData.data.baseWeaponEffectList[GameManager.Instance.weaponData.baseWeaponLevel].attackEffect.slow.valueB.ToString();
        ...
        before_AT_DotDuration_TMP.text = GameManager.Instance.weaponData.data.baseWeaponEffectList[GameManager.Instance.weaponData.baseWeaponLevel].attackEffect.dotDamage.valueB.ToString();

        after_AT_AttackDamage_TMP.text = (GameManager.Instance.weaponData.totalDamage * GameManager.Instance.weaponData.data.baseWeaponEffectList[GameManager.Instance.weaponData.baseWeaponLevel + 1].attackEffect.damageMultiple).ToString();
        ...
        after_AT_StunDuration_TMP.text = GameManager.Instance.weaponData.data.baseWeaponEffectList[GameManager.Instance.weaponData.baseWeaponLevel + 1].attackEffect.stun.valueB.ToString();
        after_AT_SlowDuration_TMP.text = GameManager.Instance.weaponData.data.baseWeaponEffectList[GameManager.Instance.weaponData.baseWeaponLevel + 1].attackEffect.slow.valueA.ToString();
        after_AT_SlowDecrease_TMP.text = GameManager.Instance.weaponData.data.baseWeaponEffectList[GameManager.Instance.weaponData.baseWeaponLevel + 1].attackEffect.slow.valueB.ToString();
        ...
        after_AT_DotDuration_TMP.text = GameManager.Instance.weaponData.data.baseWeaponEffectList[GameManager.Instance.weaponData.baseWeaponLevel + 1].attackEffect.dotDamage.valueB.ToString();

        before_DropAT_AttackDamage_TMP.text = (GameManager.Instance.weaponData.totalDamage * GameManager.Instance.weaponData.data.baseWeaponEffectList[GameManager.Instance.weaponData.baseWeaponLevel].dropEffect.damageMultiple).ToString();
        ...
        before_DropAT_StunDuration_TMP.text = GameManager.Instance.weaponData.data.baseWeaponEffectList[GameManager.Instance.weaponData.baseWeaponLevel].dropEffect.stun.valueB.ToString();
        before_DropAT_SlowDuration_TMP.text = GameManager.Instance.weaponData.data.baseWeaponEffectList[GameManager.Instance.weaponData.baseWeaponLevel].dropEffect.slow.valueA.ToString();
        before_DropAT_SlowDecrease_TMP.text = GameManager.Instance.weaponData.data.baseWeaponEffectList[GameManager.Instance.weaponData.baseWeaponLevel].dropEffect.slow.valueB.ToString();
        ...
        before_DropAT_DotDuration_TMP.text = GameManager.Instance.weaponData.data.baseWeaponEffectList[GameManager.Instance.weaponData.baseWeaponLevel].dropEffect.dotDamage.valueB.ToString();

        after_DropAT_AttackDamage_TMP.text = (GameManager.Instance.weaponData.totalDamage * GameManager.Instance.weaponData.data.baseWeaponEffectList[GameManager.Instance.weaponData.baseWeaponLevel + 1].dropEffect.damageMultiple).ToString();
        ...
        after_DropAT_StunDuration_TMP.text = GameManager.Instance.weaponData.data.baseWeaponEffectList[GameManager.Instance.weaponData.baseWeaponLevel + 1].dropEffect.stun.valueB.ToString();
        after_DropAT_SlowDuration_TMP.text = GameManager.Instance.weaponData.data.baseWeaponEffectList[GameManager.Instance.weaponData.baseWeaponLevel + 1].dropEffect.slow.valueA.ToString();
        after_DropAT_SlowDecrease_TMP.text = GameManager.Instance.weaponData.data.baseWeaponEffectList[GameManager.Instance.weaponData.baseWeaponLevel + 1].dropEffect.slow.valueB.ToString();
        ...
        after_DropAT_DotDuration_TMP.text = GameManager.Instance.weaponData.data.baseWeaponEffectList[GameManager.Instance.weaponData.baseWeaponLevel + 1].dropEffect.dotDamage.valueB.ToString();

        before_ChargeAT_AttackDamage_TMP.text = (GameManager.Instance.weaponData.totalDamage * GameManager.Instance.weaponData.data.baseWeaponEffectList[GameManager.Instance.weaponData.baseWeaponLevel].chargeEffect.damageMultiple).ToString();
        ...
        before_ChargeAT_StunDuration_TMP.text = GameManager.Instance.weaponData.data.baseWeaponEffectList[GameManager.Instance.weaponData.baseWeaponLevel].chargeEffect.stun.valueB.ToString();
        before_ChargeAT_SlowDuration_TMP.text = GameManager.Instance.weaponData.data.baseWeaponEffectList[GameManager.Instance.weaponData.baseWeaponLevel].chargeEffect.slow.valueA.ToString();
        before_ChargeAT_SlowDecrease_TMP.text = GameManager.Instance.weaponData.data.baseWeaponEffectList[GameManager.Instance.weaponData.baseWeaponLevel].chargeEffect.slow.valueB.ToString();
        ...
        before_ChargeAT_DotDuration_TMP.text = GameManager.Instance.weaponData.data.baseWeaponEffectList[GameManager.Instance.weaponData.baseWeaponLevel].chargeEffect.dotDamage.valueB.ToString();

        after_ChargeAT_AttackDamage_TMP.text = (GameManager.Instance.weaponData.totalDamage * GameManager.Instance.weaponData.data.baseWeaponEffectList[GameManager.Instance.weaponData.baseWeaponLevel + 1].chargeEffect.damageMultiple).ToString();
        ...
        after_ChargeAT_StunDuration_TMP.text = GameManager.Instance.weaponData.data.baseWeaponEffectList[GameManager.Instance.weaponData.baseWeaponLevel + 1].chargeEffect.stun.valueB.ToString();
        after_ChargeAT_SlowDuration_TMP.text = GameManager.Instance.weaponData.data.baseWeaponEffectList[GameManager.Instance.weaponData.baseWeaponLevel + 1].chargeEffect.slow.valueA.ToString();
        after_ChargeAT_SlowDecrease_TMP.text = GameManager.Instance.weaponData.data.baseWeaponEffectList[GameManager.Instance.weaponData.baseWeaponLevel + 1].chargeEffect.slow.valueB.ToString();
        ...
        after_ChargeAT_DotDuration_TMP.text = GameManager.Instance.weaponData.data.baseWeaponEffectList[GameManager.Instance.weaponData.baseWeaponLevel + 1].chargeEffect.dotDamage.valueB.ToString();

        before_DashAT_AttackDamage_TMP.text = (GameManager.Instance.weaponData.totalDamage * GameManager.Instance.weaponData.data.baseWeaponEffectList[GameManager.Instance.weaponData.baseWeaponLevel].dashEffect.damageMultiple).ToString();
        ...
        before_DashAT_StunDuration_TMP.text = GameManager.Instance.weaponData.data.baseWeaponEffectList[GameManager.Instance.weaponData.baseWeaponLevel].dashEffect.stun.valueB.ToString();
        before_DashAT_SlowDuration_TMP.text = GameManager.Instance.weaponData.data.baseWeaponEffectList[GameManager.Instance.weaponData.baseWeaponLevel].dashEffect.slow.valueA.ToString();
        before_DashAT_SlowDecrease_TMP.text = GameManager.Instance.weaponData.data.baseWeaponEffectList[GameManager.Instance.weaponData.baseWeaponLevel].dashEffect.slow.valueB.ToString();
        ...
        before_DashAT_DotDuration_TMP.text = GameManager.Instance.weaponData.data.baseWeaponEffectList[GameManager.Instance.weaponData.baseWeaponLevel].dashEffect.dotDamage.valueB.ToString();

        after_DashAT_AttackDamage_TMP.text = (GameManager.Instance.weaponData.totalDamage * GameManager.Instance.weaponData.data.baseWeaponEffectList[GameManager.Instance.weaponData.baseWeaponLevel + 1].dashEffect.damageMultiple).ToString();
        ...
        after_DashAT_StunDuration_TMP.text = GameManager.Instance.weaponData.data.baseWeaponEffectList[GameManager.Instance.weaponData.baseWeaponLevel + 1].dashEffect.stun.valueB.ToString();
        after_DashAT_SlowDuration_TMP.text = GameManager.Instance.weaponData.data.baseWeaponEffectList[GameManager.Instance.weaponData.baseWeaponLevel + 1].dashEffect.slow.valueA.ToString();
        after_DashAT_SlowDecrease_TMP.text = GameManager.Instance.weaponData.data.baseWeaponEffectList[GameManager.Instance.weaponData.baseWeaponLevel + 1].dashEffect.slow.valueB.ToString();
        ...
        after_DashAT_DotDuration_TMP.text = GameManager.Instance.weaponData.data.baseWeaponEffectList[GameManager.Instance.weaponData.baseWeaponLevel + 1].dashEffect.dotDamage.valueB.ToString();
    }
